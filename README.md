...
**Documentation (German)**  | https://docs.goobi.io/de/workflow/plugins/workflow/goobi-plugin-workflow-file-upload-process-creation
**Documentation (English)** | https://docs.goobi.io/en/workflow/plugins/workflow/goobi-plugin-workflow-file-upload-process-creation
